...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec 23 08:46:04 2024
Objective:
    - Train ResNet-169 to differentiate MRI with tumor with that of no-tumor
@author: dagi
"""
import os 
import sys 
...
rootPath = "/media/Linux/Mallie_Dagmawi/PyTorch/data/Dataset/Final_3/Classification/Cascading_2/Model_1/"
...
HEIGHT = 256
BATCH = 2**6
OUTPUT_SHAPE = 1 #  0: No_tumor, 1: With_tumor
EPOCH = 100
LEARNING_RATE = 1e-4
...
plt.title(label="Model_1: ResNet-50")
